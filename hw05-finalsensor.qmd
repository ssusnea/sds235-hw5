...
g <- ggplot() +
  ...
  scale_frame_
  labs(title = 'Measured Radiation in St. Himark <br> <sup> Average value per hour from April 6 to April 10, 2020 </sup>',
...
g <- ggplot() +
  ...
  labs(title = 'Measured Radiation in St. Himark <br> <sup> Maximum value per hour from April 6 to April 10, 2020 </sup>', 
       fill = "Measured Radiation (cpm)",
